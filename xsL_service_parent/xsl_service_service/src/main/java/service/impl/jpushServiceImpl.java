...
public class jpushServiceImpl implements jpushService {
	...
	private  PushPayload buildPushObject_android_and_ios(String notification_title, String msg_title, String msg_content, String extrasparam) {
		return PushPayload.newBuilder()
						...
						.addExtra("taskId", extrasparam).build()).addPlatformNotification(IosNotification.newBuilder()
						...
						.setMessage(Message.newBuilder().setMsgContent(msg_content).setTitle(msg_title).addExtra("taskId", extrasparam).build())
